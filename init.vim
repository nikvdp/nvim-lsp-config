...
require'nvim-treesitter.configs'.setup {
    -- you can also list languages one by one below if you don't want to use
    -- treesitter for all filetypes, eg { "python" }
    ...
    -- ensure_installed can be: "all", or a list of languages
}
EOF
